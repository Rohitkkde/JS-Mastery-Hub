    ...
    <div className="container mx-auto px-4">
      ...
      <div className="relative">
        <div className="animate-float mx-auto w-32 h-32 md:w-48 md:h-48 bg-yellow-lemon rounded-lg flex items-center justify-center">
          ...
          <div className="absolute -top-6 -right-6 bg-blue-dark hover:bg-blue-dark/90 transition-colors text-white rounded-full w-16 h-16 p-4 flex flex-col items-center justify-center group cursor-pointer">
            <svg width="24" height="24" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-1">
            ...
            <span className="text-[10px] font-mono">ENROLL NOW</span>
          </div>
        </div>
      </div>
