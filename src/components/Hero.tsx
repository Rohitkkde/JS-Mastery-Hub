  ...
  return (
    <div className='relative min-h-screen pt-20 overflow-hidden'>
      <div className='container mx-auto px-4'>
        ...
        <div className='absolute top-5 lg:top-20 lg:left-80 text-yellow-mango -rotate-12'>
          <Sparkle fill='#FFD37D' width={90} height={90} />
        </div>
        <div className='absolute top-72 lg:top-80 right-8 lg:right-64 text-orange rotate-12'>
          <Sparkle fill='#F57642' width={80} height={80} />
        </div>
        <div className='absolute top-64 lg:top-48 lg:left-48 text-blue-light font-bold text-[7rem] lg:text-[9rem] rotate-12'>
          <AngularBracket />
        </div>
        <div className='absolute top-0 lg:top-20 right-10 lg:right-56 text-blue-dark font-bold text-8xl lg:text-9xl -rotate-[190deg]'>
          <AngularBracket />
        </div>
      </div>
    </div>
