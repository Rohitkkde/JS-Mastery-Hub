      ...
      <div className="container mx-auto px-4">
        <h1 className="text-5xl lg:text-8xl font-bold mx-auto text-center mt-20 mb-12">
          Master <span className="relative inline-block">
            JavaScript
            <svg width="561" height="178" viewBox="0 0 561 178" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200%] h-[200%] -rotate-6 -z-10">
