...
const FeaturesSection = () => {
  ...
  const xPosition = useTransform(scrollYProgress, [0, 1], ["0%", "-66%"])

  return (
    <section 
      ref={sectionRef}
      className='bg-black relative h-[300vh] flex flex-col overflow-hidden'
    >
      {/* Sticky container to maintain position during scroll */}
      <div className='sticky top-0 h-screen flex items-center overflow-hidden'>
        {/* Title with fixed position */}
        <div className='absolute left-16 z-10 text-white'>
        ...
        <motion.div 
          style={{ x: xPosition }} 
          className='flex gap-8 pl-[700px] pr-32'
        >
          {/* Feature Cards */}
          ...
          {/* Add one more card to ensure we have enough content for scrolling */}
          <Card className='h-full min-w-[500px] p-16 bg-[#212121] text-white border-none rounded-xl shrink-0'>
            <h3 className='text-4xl font-bold mb-4'>Community Projects</h3>
            <p className='text-gray-300 text-xl font-medium'>
              Work on real-world projects with other students and build a portfolio
              of collaborative work to showcase your skills to potential employers.
            </p>
            <div className='mt-10 flex justify-center'>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-light/30 rounded-lg p-4 flex items-center justify-center h-32">
                  <span className="text-white text-xl font-mono">Project 1</span>
                </div>
                <div className="bg-yellow-mango/30 rounded-lg p-4 flex items-center justify-center h-32">
                  <span className="text-white text-xl font-mono">Project 2</span>
                </div>
                <div className="bg-orange/30 rounded-lg p-4 flex items-center justify-center h-32">
                  <span className="text-white text-xl font-mono">Project 3</span>
                </div>
                <div className="bg-blue-dark/30 rounded-lg p-4 flex items-center justify-center h-32">
                  <span className="text-white text-xl font-mono">Project 4</span>
                </div>
              </div>
            </div>
          </Card>
